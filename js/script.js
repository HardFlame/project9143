   ...
   fill : [
      {
         ...
         fill : [
            {
               name : 'Доставлен',
               fill : ['По информации из CRM: ',' Доставлен (вручен).'],
            },
            {
               name : 'Вручено',
               fill : ['По информации из CRM: ',' Передан в доставку: Вручено Покупателю.'],
            },
            {
               name : 'Отменен',
               fill : ['Статус конечный: Отменен.'],
            },
            {
               name : 'передан(1)',
               fill : ['Передан в доставку: передан в доставку (один подстатус).'],
            },
            {
               name : 'передан(2)',
               fill : ['Передан в доставку: передан в доставку (два подстатуса).'],
            },
            {
               name : 'Клиент',
               fill : ['Звонок клиенту: ',''],
      ...
      },
      {
         ...
         fill : [
            {
               name : 'Дата доставки',
               fill : ['Здравствуйте, коллеги!\nПросьба уточнить почему заказ ',' не был доставлен в срок и когда будет доставлен.\nЗаранее спасибо.'],
            },
            {
               name : 'Дата доставки(АПП)',
               fill : ['Здравствуйте, коллеги!\nПросьба уточнить почему заказ ',' не был доставлен в срок и когда будет доставлен.\nЗаказ был передан вам ',' , АПП во вложении, строка ','.\nЗаранее спасибо.'],
            },
            {
               name : 'Дата отгрузки',
               fill : ['Здравствуйте, коллеги!\nПросьба уточнить почему заказ ',' не был отгружен в срок и когда будет отгружен.\nЗаранее спасибо.'],
            },
            {
               name : 'Дата отгрузки(АПП)',
               fill : ['Здравствуйте, коллеги!\nПросьба уточнить почему заказ ',' не был отгружен в срок и когда будет отгружен.\nЕсли заказ уже отгружен, просьба предоставить АПП.\nНа FTP за ',' АПП не найден.\nЗаранее спасибо.'],
            },
         ]
      },
      {
...
            {
               name : 'Недозвон(смс)',
               fill : ['К сожалению, мне не удалось дозвониться Вам по заказу ${order.number} на маркетплейсе Яндекс Маркет. Перезвоните, пожалуйста, для согласования даты доставки: 8-800-234-27-12.'],
            },
            {
               name : 'Недозвон(письмо)',
               fill : ['',', добрый день!\nСегодня мне не удалось до Вас дозвониться, чтобы согласовать дату и время доставки заказа ',' на маркетплейсе Яндекс Маркет. Перезвоните, пожалуйста, по номеру 8-800-234-27-12.\nСпасибо.'],
            },
         ],
      },
   ]
